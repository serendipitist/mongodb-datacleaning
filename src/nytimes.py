...
API_KEY = { "popular": "a10b978c31c7637a4ebcc88d535e5b9d:7:69429861",
            "article": ""
            }
...
def query_site(url, target, offset):
    ...
    #http://api.nytimes.com/svc/mostpopular/v2/mostshared/all-sections//30.json?api-key=####
    ...
    # params = {"api-key": 'a10b978c31c7637a4ebcc88d535e5b9d:7:69429861', "offset": 0}
...
if __name__ == "__main__":
    test()
    # print get_popular(URL_MAIN, kind, days, section="all-sections", offset=0)
